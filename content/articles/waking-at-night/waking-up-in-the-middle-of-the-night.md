---
title: "Waking Up in the Middle of the Night: Causes and What to Do"
description: "Waking up in the middle of the night is normal; staying awake is the problem. A checklist of causes, from noise and heat to stress and apnoea, and what helps."
standfirst: "Everyone wakes in the night. The question is why you are noticing it, why you are not drifting straight back, and which of the usual causes applies to you. Here's how to work through them."
published: 2026-09-25
updated: 2026-09-25
illustration: moon
imageAlt: "A crescent moon over a dark bedroom window"
readNext:
  - waking-at-night/waking-up-at-3am
  - waking-at-night/cant-get-back-to-sleep
  - sleep-products/best-earplugs-for-sleeping-uk
faq:
  - q: "How many times a night is it normal to wake up?"
    a: "Adults typically surface briefly several times a night, usually at the end of a sleep cycle, and forget almost all of them. Waking once and remembering it, especially in the second half of the night, is common and not a problem in itself. It becomes one when wakings are frequent, long, or leave you unrefreshed most days."
  - q: "What is sleep maintenance insomnia?"
    a: "It is the term for insomnia where the main difficulty is staying asleep rather than falling asleep: frequent or prolonged wakings, three or more nights a week, for three months or more, with a knock-on effect on your day. It is common, and cognitive behavioural therapy for insomnia (CBT-I) is the recommended first treatment."
  - q: "Why do I wake up every night at the same time?"
    a: "Usually because your sleep cycles run to a fairly regular timetable, so light sleep arrives at the same point each night, and because you have learned to check the clock at that moment. External cues such as heating timers, a partner's alarm or early traffic often play a part too."
  - q: "Should I see a GP about waking in the night?"
    a: "Yes, if it has gone on for more than a few weeks and is affecting your days, or if it comes with loud snoring or gasping, pain, breathlessness, low mood, night sweats, or needing the toilet several times a night. These are all things a GP can look into."
sources:
  - title: "Insomnia"
    publisher: "NHS"
...
A GP can check for the treatable causes above and, if the problem is insomnia, tell you how to access CBT-I locally. There is a fuller guide to [when to see a GP about sleep](@sleep-questions/when-to-see-a-gp-about-sleep).

## Where to go next

Tonight, hide the clock and keep the room dark and cool. This week, pick the one cause from the checklist that most obviously applies and change it. The [Waking at Night guides](@waking-at-night) cover each pattern in more depth, from early waking to feeling hot at night, and the read-next articles below are the natural next steps.
